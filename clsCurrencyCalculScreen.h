...
private:
    ...
    static clsBankCurrency _GetCurrency(string Message)
    {
    ...
    static  void _PrintCurrencyCard(clsBankCurrency Currency, string Title = "Currency Card:")
    {
    ...
    static void _PrintCalculationsResults(float Amount, clsBankCurrency Currency1, clsBankCurrency Currency2)
    {
...
public:
    ...
    static void ShowCurrencyCalculatorScreen()
    {
        ...
        while (Continue == 'y' || Continue == 'Y')
        {
            ...
            _ScreenHeader("\t\t Calculator Screen");

            clsBankCurrency CurrencyFrom = _GetCurrency("\nPlease Enter Currency[1] Code: ");
            clsBankCurrency CurrencyTo = _GetCurrency("\nPlease Enter Currency[2] Code: ");
